...
if (isset($_POST["save"])) {
    ...
    //---------------check valid form-------------------------
        ...
        if ($isOk4 == false) {
            $alertmsg4 = "โปรดระบุเหตุผล" ;
        }
        //---------------------------------------
        if ($isOk1 == true AND $isOk2 == true AND $isOk3 == true AND $isOk4 == true) {
            $result3 = true ;
        } else {
            $result3 = false ;
        }
    ...
    if($ot == "lunch"){
        if((decimalHours($time_start) >= decimalHours('12:00')) && (decimalHours($time_start) <= decimalHours('13:00'))){
            if((decimalHours($time_end) >= decimalHours('12:00')) && (decimalHours($time_end) <= decimalHours('13:00')) && $result2==true && $result3==true){
                                        ...
                                        <div class="row">
                                            <div class="col-12 grid-margin stretch-card">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <form name="myForm" class="forms-sample" method="POST">
                                                            <div class="row">
                                                                <div class="col-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <font color="red"><?= $alertmsg12?></font>
